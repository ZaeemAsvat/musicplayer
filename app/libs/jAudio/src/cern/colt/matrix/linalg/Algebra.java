...
Cell <tt>A[i]</tt> will start into cell <tt>A[indexes[i]]</tt>.
<p>
<b>Example:</b>
<pre>
Reordering
...
Column <tt>A[i]</tt> will start into column <tt>A[indexes[i]]</tt>.
...
Row <tt>A[i]</tt> will start into row <tt>A[indexes[i]]</tt>.
<p>
<b>Example:</b>
<pre>
Reordering
