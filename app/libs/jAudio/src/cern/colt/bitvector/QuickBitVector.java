...
public static void putLongFromTo(long[] bits, long value, int from, int to) {
	...
	*/
	...
	if (fromIndex==toIndex) { //range does not cross unit boundaries; should start into one single long value.
	...
	//range crosses unit boundaries; value should start into two long values.
